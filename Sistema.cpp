...
void Sistema::imprimirJugadores(DtJugador** dtjs, int cant){
...
void Sistema::imprimirPartidas(DtPartida** dtps, int cant){
    cout << "\nListado de partidas\n" << endl;
    cout << "-----------------------------------------\n" << endl;
    for(int i=0; i<cant; i++){
...
void Sistema::imprimirVideojuegos(DtJuego** dtgs, int cant){
...
void Sistema::menuAgregarJugador(){
...
void Sistema::menuAgregarVideoJuego(){
    string nombre;
    int genero;
...
void Sistema::menuIniciarPartida(){
